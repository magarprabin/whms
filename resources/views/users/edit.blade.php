            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="form-group {{ $errors->has('first_name') ? 'has-error' : '' }}">
                  <label class="col-md-3 control-label" for="first_name">{{ trans('general.first_name') }}<span class="req">*</span></label>
                ...
                <div class="form-group {{ $errors->has('username') ? 'has-error' : '' }}">
                  <label class="col-md-3 control-label" for="username">{{ trans('admin/users/table.username') }}<span class="req">*</span></label>
                ...
                <div class="form-group {{ $errors->has('password') ? 'has-error' : '' }}">
                  <label class="col-md-3 control-label" for="password">
                    {{ trans('admin/users/table.password') }}<span class="req">*</span>
                  </label>
                  <div class="col-md-6{{  (\App\Helpers\Helper::checkIfRequired($user, 'password')) ? ' required' : '' }}">
                    ...
                    {!! $errors->first('password', '<span class="alert-msg" aria-hidden="true" id="generated-password-valid">:message</span>') !!}
                  </div>
                  <div class="col-md-2">
                ...
                <div class="form-group {{ $errors->has('password_confirmation') ? 'has-error' : '' }}">
                  <label class="col-md-3 control-label" for="password_confirmation">
                    {{ trans('admin/users/table.password_confirm') }}<span class="req">*</span>
                  </label>
              ...
              <!-- Activation Status -->
                ...
                @if (\App\Models\Company::canManageUsersCompanies())
                    @include ('partials.forms.edit.company-select-user', ['translated_name' => trans('general.select_company'), 'fieldname' => 'company_id'])
                @endif
              ...
              @include ('partials.forms.edit.department-select', ['translated_name' => trans('general.department'), 'fieldname' => 'department_id'])
                  ...
                  <!-- Location -->
                @include ('partials.forms.edit.location-select-user-add', ['translated_name' => trans('general.location'), 'fieldname' => 'location_id', 'user_location_id' => $user_location_id])
                ...
                <div class="form-group{!! $errors->has('notes') ? ' has-error' : '' !!}">
                  ...
                  <div class="form-group{{ $errors->has('groups') ? ' has-error' : '' }}">
                      <label class="col-md-3 control-label" for="groups[]"> {{ trans('general.groups') }}<span class="req">*</span></label>
                      <div class="col-md-6">
...
$(document).ready(function() {
  var password_error = $("#generated-password-valid").html();
  if(password_error == 'validation.case_diff' || password_error == 'validation.letters' || password_error == 'validation.numbers'){
    $("#generated-password-valid").html('The password should contain combination of letters and numbers and one letter should be of uppercase');
  }

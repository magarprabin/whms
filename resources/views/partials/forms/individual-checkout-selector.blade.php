<div class="form-group" id="assignto_selector"{!!  (isset($style)) ? ' style="'.e($style).'"' : ''  !!}>
    ...
    <div class="col-md-8">
        <div class="btn-group" data-toggle="buttons">
            ...
            <label class="btn btn-default">
                <input name="checkout_to_type" value="location" aria-label="checkout_to_type" type="radio" checked="checked"><i class="fa fa-map-marker" aria-hidden="true"></i> {{ trans('general.location') }}
            </label>
            @endif

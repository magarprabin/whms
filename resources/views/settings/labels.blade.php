                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <div class="checkbox">
                                    ...
                                    <label for="labels_display_tag_inventory">
                                        {{ Form::checkbox('labels_display_tag_inventory', '1', old('labels_display_tag_inventory',   $setting->labels_display_tag_inventory),['class' => 'minimal', 'aria-label'=>'labels_display_tag_inventory']) }}
                                        {{ trans('admin/hardware/form.invtag') }}
                                    </label>

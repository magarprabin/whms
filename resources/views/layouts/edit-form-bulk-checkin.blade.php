...
<div class="row">
    <!-- col-md-8 -->
    <div class="col-lg-11 col-lg-offset-2 col-md-12 col-md-offset-1 col-sm-12 col-sm-offset-0 shipment-details-col" style="margin-left: 30px;">
        ...
        <div class="box box-default">
            ...
            <div class="box-body">
                    ...
                    {{ csrf_field() }}
                    @yield('inputFields')
                    @include('partials.forms.edit.submit-first-time-checkin')

          ...
          <!-- Navbar Right Menu -->
            <div class="navbar-custom-menu">
              <ul class="nav navbar-nav">
                  ...
                  @can('index', \App\Models\Asset::class)
                  <li>
                  <form class="navbar-form navbar-left form-horizontal" role="search" action="{{ route('findbyshipmentnumber/hardware') }}" method="get">
                      <div class="col-xs-12 col-md-12">
                          <div class="col-xs-12 form-group">
                              <label class="sr-only" for="tagSearch">{{ trans('general.lookup_by_tag') }}</label>
                              <input type="text" class="form-control tag-search" id="tagSearch" name="assetShipmentNumber" placeholder="{{ trans('general.lookup_by_tag') }}" style="width: 210px;">
          ...
          <ul class="sidebar-menu" data-widget="tree">
            ...
            @can('backend.interact')
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        @endcan
                            <li>
                                <a href="{{ route('routes.index') }}" {{ (Request::is('/routes') ? ' class="active"' : '') }}>
                                    {{ trans('general.routes') }}
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('riders.index') }}" {{ (Request::is('/riders') ? ' class="active"' : '') }}>
                                    {{ trans('general.riders') }}
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('vehicles.index') }}" {{ (Request::is('/vehicles') ? ' class="active"' : '') }}>
                                    {{ trans('general.vehicles') }}
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('logistic_categories.index') }}" {{ (Request::is('/logistic_categories') ? ' class="active"' : '') }}>
            ...
            <li class="treeview{{ (Request::is('reports*') ? ' active' : '') }}">
                ...
                <ul class="treeview-menu">
                    ...
                    <li>
                        <a href="{{ route('reports.history') }}" {{ (Request::is('reports/history') ? ' class="active"' : '') }}>
                            History Report
                        </a>
                    </li>
                </ul>

...
class Asset extends Depreciable
{
  ...
  */
        ...
        return $query->where(function ($query) use ($filter) {
            foreach ($filter as $key => $search_val) {
                ...
                if ($fieldname =='carrier') {
                    $query->whereHas('carrier', function ($query) use ($search_val) {
                        $query->where('carrier.carrier_name', 'LIKE', '%' . $search_val . '%');
                    });
                }
            ...
            if (($fieldname!='category') && ($fieldname!='model_number') && ($fieldname!='rtd_location') && ($fieldname!='location') && ($fieldname!='supplier')
                && ($fieldname!='status_label') && ($fieldname!='model') && ($fieldname!='company') && ($fieldname!='manufacturer') && ($fieldname!='carrier')) {
    ...
    */
     ...
     * @return boolean
     */
    public function bulkCheckOut($target, $admin = null, $checkout_at = null, $expected_checkin = null, $note = null, $name = null, $location = null)
    {
        if (!$target) {
            return false;
        }
     ...
     * @return boolean
     */
    public function checkOutIndividual($target, $admin = null, $checkout_at = null, $expected_checkin = null, $note = null, $name = null, $location = null)
    {
        if (!$target) {
            return false;
        }
    ...
    /**
     * Establishes the asset -> carrier relationship
     *

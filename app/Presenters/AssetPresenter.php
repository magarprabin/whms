    ...
    public static function dataTableLayout()
    {
        $layout = [
            [
                ...
                "searchable" => true,
                "sortable" => true,
                "title" => trans('admin/hardware/table.customer_name'),
                "visible" => true,
                "formatter" => "hardwareLinkFormatter"
            ], [
                ...
                "field" => "statuslabel_list",
                "searchable" => true,
                "sortable" => true,
                "title" => 'Status Action',
                "visible" => true,
                "formatter" => "statuslabelsEditFormatter"
            ], [
                "field" => "assigned_to",
                "searchable" => true,
                "sortable" => true,
                ...
                "title" => 'Carrier',
                "visible" => true,
                "formatter" => "deployedCarrierFormatter"
            ], [
                "field" => "manufacturer",
                "searchable" => true,
                "sortable" => true,
                ...
                "switchable" => true,
                "title" => 'Label',
                "formatter" => "hardwareLabelFormatter",
            ], [
                "field" => "order_number",
                "searchable" => true,
                "sortable" => true,

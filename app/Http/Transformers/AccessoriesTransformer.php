...
class AccessoriesTransformer
{
    ...
    public function transformAccessories (Collection $accessories, $total)
    {
        ...
        foreach ($accessories as $accessory) {
            foreach ($accessory->users as $accessor) {
                $orderNumber[$accessor->pivot->accessory_id] = $accessor->pivot->order_number;
            }
            $accessory->order_no = $orderNumber;
    ...
    public function transformAccessory (Accessory $accessory)
    {
        $array = [
            ...
            'image' => ($accessory->image) ? './uploads/accessories/'.e($accessory->image) : null,
            ...
            'order_number' => isset($accessory->order_no[$accessory->id]) ? e($accessory->order_no[$accessory->id]) : null,
            'min_qty' => ($accessory->min_amt) ? (int) $accessory->min_amt : null,
            'remaining_qty' => $accessory->numRemaining(),

            'created_at' => Helper::getFormattedDateObject($accessory->created_at, 'datetime'),
            'updated_at' => Helper::getFormattedDateObject($accessory->updated_at, 'datetime'),
            'inventory_tag' => ($accessory->inventory_tag) ? e($accessory->inventory_tag) : null,
    ...
    public function transformCheckedoutAccessory ($accessory, $accessory_users, $total)
    {
        ...
        foreach ($accessory_users as $user) {
            ...
            $array[] = [
                ...
                'checkout_order_number' => e($user->pivot->order_number),

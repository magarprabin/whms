...
class UsersController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        $company_lists = Company::get();
        return view('users/edit', compact('groups', 'userGroups', 'permissions', 'userPermissions'))
            ->with('item', $item)
            ->with('user', $user)
            ->with('locations', $locations)
            ->with('user_location_id', $user_location_id)
            ->with('company_lists', $company_lists);
    }
    ...
    public function store(SaveUserRequest $request)
    {
        ...
        $user->company_id = $request->input('company_id', null);
    ...
    public function edit($id)
    {
        if ($user =  User::find($id)) {
            ...
            $company_lists = Company::get();
            return view('users/edit', compact('user', 'groups', 'userGroups', 'permissions', 'userPermissions'))->with('item', $user)->with('locations', $locations)->with('user_location_id', $user_location_id)->with('company_lists', $company_lists);
        }

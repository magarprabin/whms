...
Route::group(['prefix' => 'v1','namespace' => 'Api', 'middleware' => ['api', 'throttle:'.config('app.api_throttle_per_minute').',1']], function () {
    ...
    Route::group(['prefix' => 'hardware'], function () {
        ...
        Route::put('updateShipmentStatus/{shipment_number}', 
            [
                'as' => 'api.assets.updateShipmentStatus',
                'uses' => 'AssetsController@updateFromCsCart',
            ]
        );

        Route::put('addFulfillmentStarted/{shipment_number}', 
            [
                'as' => 'api.assets.addFulfillmentStarted',
                'uses' => 'AssetsController@addFulfillmentStarted',
            ]
        );
    ...
    Route::group(['prefix' => 'suppliers'], function () {
        ...
        Route::get('filtered-suppliers',
            [
                'as'=>'api.filtered-suppliers.selectlist',
                'uses'=>'SuppliersController@getFilteredSuppliers'
            ]
        );
    }); // Suppliers group
    ...
    Route::group(['prefix' => 'filtered-suppliers'], function () {

        Route::get('selectlist',
            [
                'as'=>'api.filtered-suppliers.selectlist',
                'uses'=>'FilteredSuppliersController@getFilteredSuppliers'
            ]
        );
    }); // Filtered Suppliers group
    ...
    Route::resource('riders', 'RidersController',
        [
            'names' =>
                [
                    'index' => 'api.riders.index',
                    'show' => 'api.riders.show',
                    'store' => 'api.riders.store',
                    'update' => 'api.riders.update',
                    'destroy' => 'api.riders.destroy'
                ],
            'except' => ['edit', 'create'],
        ...
        [
            'names' =>
                [
                    ...
                    'show' => 'api.pod.show',
                    'store' => 'api.pod.store',
                    'update' => 'api.pod.update',
                    'destroy' => 'api.pod.destroy'
                ],
            'except' => ['edit', 'create'],
...
// Vehicles group
    ...
    Route::group(['prefix' => 'filtered-users'], function () {

        Route::get('selectlist',
            [
                'as' => 'api.filtered-users.selectlist',
                'uses' => 'FilteredUsersController@selectlist'
            ]
        );

    });

    // Logistic Categories group
    Route::resource('logistic_categories', 'LogisticCategoriesController',
        [
            'names' =>
                [
                    'index' => 'api.logistic_categories.index',
                    'show' => 'api.logistic_categories.show',
                    'store' => 'api.logistic_categories.store',
                    'update' => 'api.logistic_categories.update',
                    'destroy' => 'api.logistic_categories.destroy'
                ],
            'except' => ['edit', 'create'],
    ...
    Route::group(['prefix' => 'filtered-categories'], function () {

        Route::get('selectlist',
            [
                'as' => 'api.filtered-categories.selectlist',
                'uses' => 'FilteredCategoriesController@selectlist'
            ]
        );
    });
    Route::group(['prefix' => 'filtered-logisticcategories'], function () {

        Route::get('selectlist',
            [
                'as' => 'api.filtered-logisticcategories.selectlist',
                'uses' => 'FilteredCategoriesController@selectlist_logistic'
            ]
        );

    });
    
    Route::group(['prefix' => 'filtered-route'], function () {

        Route::get('selectlist',
            [
                'as' => 'api.filtered-route.selectlist',
                'uses' => 'FilteredCategoriesController@selectlist_route'
            ]
        );
    });
});
